...
ActiveRecord::Schema.define(version: 20170306030300) do

  create_table "piles", primary_key: "pile_id", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "user_id"
